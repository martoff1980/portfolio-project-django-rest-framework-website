...
- **Station control** `(train-station/)`: \
  **GET/POST** /api/train-station/stations/ — list and creation of stations. \
  **GET/POST** /api/train-station/routes/ — list and creation of routes. \
  **GET/POST** /api/train-station/trains/ — list and create trains (?train_type= filters available). \
  **GET/POST** /api/train-station/journeys/ — journeys (filters available ?source=, ?destination=, ?date=, ?route=). \
